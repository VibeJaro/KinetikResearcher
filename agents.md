...
- Neues UI/UX-Grundgerüst: Sticky Header mit Nutzer-Badge, horizontaler Stepper mit Fortschrittsbalken (6 Schritte, Abweichungen + Repräsentativität kombiniert, Reaktionsnetzwerk vor Modeling), card-basierte Screens im mittig ausgerichteten Container.
- Step-Spezifika aus dem Draft (müssen in der App erkennbar sein):
  ...
  - Reaktionsnetzwerk: Spaltenrollen (Edukt/Produkt/Zwischen-/Nebenprodukt) + einfache Pfeil-Definition für Nebenpfade; Abschluss-CTA „Weiter zum Modeling“.
  - Modeling: Fit-Strategie wählen (saubere Kinetik, Kat-Deaktivierung, unbekannte Nebenpfade), danach zweispaltig (links Fit-Parameter inkl. Arrhenius-Checkbox + R²-Summary, rechts Chart-Card mit Legende), Abschluss-CTA „Berechnen“.
...
4) **Reaktionsnetzwerk** – Rollen der Spalten + Netzwerkpfade definieren, inklusive Nebenpfaden; nutzt die in Schritt 3 getroffene Fit-Auswahl.
5) **Modeling/Fit** – verständliche Presets (z.B. “einfacher 1. Ordnung Fit”, Kat-Deaktivierung), Parameter-Erklärungen, Ergebnis-Klartext; nutzt die in Schritt 4 definierte Netzwerkstruktur.
...
8) Reaktionsnetzwerk v1 (Rollen + Pfeile) inkl. Datenbasis
9) Modeling v1 (1. Ordnung, Deaktivierung, Nebenpfade) + Diagnoseplots Placeholder
10) Report v1 (Markdown Preview + Export Dummy)
