...
- Step-Spezifika aus dem Draft (müssen in der App erkennbar sein):
  ...
  - Abweichungen & Repräsentativität: einmalige Auswahl der Kommentar- und Parameterspalten, LLM markiert Abweichungen (Call 1) und gleicht danach gegen Referenzen ab (Call 2). Ergebnisse + Fit-Auswahl je Experiment in einer gemeinsamen Kachel.
...
3) **Abweichungen & Repräsentativität (LLM)** – Nutzer:innen wählen Kommentar- und Parameterspalten einmalig. Das LLM markiert Abweichungen (Call 1) und führt direkt danach den Repräsentativitäts-Check (Call 2) aus, inkl. Fit-Empfehlung und Auswahl je Experiment.
...
Diese Schritte müssen in der Navigation erkennbar und entlang des Drafts umgesetzt sein (Stepper auf 5 Schritte, Abweichung & Repräsentativität kombiniert).
...
7) Kombinierter Abweichungsscan + Repräsentativitäts-Check (LLM-Abgleich)
