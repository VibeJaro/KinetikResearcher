...
- **Abweichungsanalyse**: Kommentarspalten wählen, relevante Parameter-Spalten als Kontext markieren, und pro Experiment einen LLM-Call mit fester Ontologie ausführen. Hinweise erscheinen kompakt (Kategorie, Quelle, Textausschnitt) ohne Bewertung.
...
- **Abweichungen (LLM)**: Neuer Schritt statt Grouping. Nutzer:innen wählen Kommentarspalten (Pflicht) und Parameter-/Bedingungsspalten (Kontext). Pro Experiment läuft genau ein LLM-Call mit den 10 definierten Kategorien. Ergebnisse erscheinen als kompakte Hinweise inkl. Quelle und Textausschnitt; Filter für „Nur Versuche ohne Auffälligkeiten“ sowie „Zeig mir alle mit Dosierabweichung“ sind integriert.
...
- Intern wird für die Abweichungsanalyse je Experiment ein schlankes JSON-Schema gehalten, z.B.:
```json
{
  "experimentId": "exp-123",
  "commentColumns": ["Kommentar", "Notiz"],
  "parameterColumns": ["Temperatur", "Additiv"],
  "findings": [
    {
      "category": "Abweichender Dosier- oder Zugabemodus",
      "snippet": "Dosierung langsam über 30 min per Pumpe",
