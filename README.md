...
- **Persistente LLM-Ergebnisse**: LLM-Scans und Fit-Vormerkungen bleiben beim Vor- und Zurückspringen erhalten; der Modeling-Schritt nutzt diese Auswahl direkt.
...
- **Modeling**: Reaktionsnetzwerk definieren – Rollen der Spalten (Edukt/Produkt/Zwischen-/Nebenprodukt) + einfache Netzwerk-Definition (Pfeile/Abzweige); Datenbasis nutzt die in Schritt 3 vorgemerkten Experimente und die gemappten Messspalten; danach Fit-Parameter inkl. Arrhenius-Checkbox + R²-Summary und rechts Chart-Card mit Legende; Abschluss-CTA „Berechnen“.
