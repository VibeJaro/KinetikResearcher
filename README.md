...
- **Modeling**: Reaktionsnetzwerk definieren – Rollen der Spalten (Edukt/Produkt/Zwischen-/Nebenprodukt) + einfache Netzwerk-Definition (Pfeile/Abzweige); danach Fit-Parameter inkl. Arrhenius-Checkbox + R²-Summary und rechts Chart-Card mit Legende; Abschluss-CTA „Berechnen“.
