    ...
    <div className="stack" aria-labelledby="import-heading">
      ...
      {!activeRawTable && (
        ...
        >
          ...
          <p className="muted">CSV oder Excel (.xlsx), max. 50MB. Datei bleibt lokal auf deinem Gerät.</p>
          <div className="upload-actions">
            ...
            <span className="muted warning-text">Achtung, keine vertraulichen Daten hochladen!</span>
          </div>
          {importError && (
